...
public class SlideViewerFrame extends JFrame {
	...
	public SlideViewerFrame(String title, Projector projector) {
		super(title);
        //Press.Projector projector = new Press.Projector();
        Painter painter = new Painter(projector, this);
		//Menu.SlideViewerComponent slideViewerComponent = new Menu.SlideViewerComponent(projector, this);
...
//Setup the GUI
	public void setupWindow(SlideViewerComponent
        ...
        setMenuBar(new MenuController(this, projector));
